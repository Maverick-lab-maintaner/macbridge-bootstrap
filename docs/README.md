...
- [MacBridge Story](./macbridge-story.md) - learning-oriented chronology of the repo, the failures, and the fixes
- [Lead Intel and Reply Assist](../LEAD_INTEL_PACER.md) - PACER-based framing for the outbound research module
- [Apple License Compliance](./APPLE_LICENSE_COMPLIANCE.md) - what Apple permits, what it forbids, and why the old multi-tenant pricing model had to die
- [Pricing Strategy](./PRICING_STRATEGY.md) - compliant pricing options and recommended commercial structure
